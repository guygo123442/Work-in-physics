...
<head>
  ...
  <title>🚀 חללית במערכת השמש — מותאם מובייל + תיקוני באגים</title>
  <style>
    :root {
      --bg: #02040a;
      --ui: #0d131a;
...
<body>
  <div class="app">
    <aside>
      <div class="title">🚀 חללית במערכת השמש</div>
      <div class="controls">
        <button class="btn" id="btnLeft">⬅︎ הקודם</button>
        <button class="btn" id="btnRight">הבא ➡︎</button>
      </div>
      <div class="card">
        <h3 id="infoTitle">בחרו כוכב</h3>
    ...
    <div class="universe-wrap" id="wrap">
      <div class="universe" id="universe">
        <button class="body sun" data-name="השמש"><div class="label">השמש</div></button>
        <button class="body mercury" data-name="כוכב חמה"><div class="label">כוכב חמה</div></button>
        <button class="body venus" data-name="נוגה"><div class="label">נוגה</div></button>
        <button class="body earth" data-name="כדור הארץ"><div class="label">כדור הארץ</div></button>
        <button class="body mars" data-name="מאדים"><div class="label">מאדים</div></button>
        <button class="body jupiter" data-name="צדק"><div class="label">צדק</div></button>
        <button class="body saturn" data-name="שבתאי"><div class="label">שבתאי</div></button>
        <button class="body uranus" data-name="אורנוס"><div class="label">אורנוס</div></button>
        <button class="body neptune" data-name="נפטון"><div class="label">נפטון</div></button>
      </div>
    </div>
  </div>
  ...
  <script>
    (function(){
      const texts = {
        "השמש": `
<b>השמש</b><br>
כוכב האם שלנו שמרכיב כ־99.8% ממסת מערכת השמש. ליבת השמש מבצעת היתוך מימן להליום ומשחררת אנרגיה אדירה שמגיעה אלינו כאור וחום. זמן הגעת האור מן השמש לכדור הארץ הוא כ־8 דקות ו־20 שניות. קוטרה ~1,392,000 ק"מ, טמפרטורת פני השטח ~5,500°C והליבה חמה במיליוני מעלות.
`,
        "כוכב חמה": `
<b>כוכב חמה (מרקורי)</b><br>
הקרוב ביותר לשמש והקטן מבין כוכבי הלכת. כמעט ללא אטמוספירה, ולכן הבדלי הטמפרטורות קיצוניים: בשמש עד ~430°C ובלילה עד ~180-°C. שנת מרקורי קצרה (כ־88 ימים), וסיבוב עצמי איטי (כ־59 ימים), כך שיום שמשי אחד ארוך במיוחד. פניו זרועים מכתשי פגיעה רבים.
`,
        "נוגה": `
<b>נוגה (ונוס)</b><br>
דומה בגודלו לכדור הארץ אך שונה מאוד בתנאים: אטמוספירה סמיכה מפחמן דו־חמצני וענני חומצה גופרתית יוצרים אפקט חממה קיצוני — טמפרטורה ממוצעת ~465°C. מסתובב לאחור (סיבוב רטרוגרדי) ובאיטיות רבה, כך שיום בנוגה ארוך משנה.
`,
        "כדור הארץ": `
<b>כדור הארץ</b><br>
כ־71% מפני השטח מכוסים מים. האטמוספירה עשירה בחנקן וחמצן ומאפשרת קיום חיים. למגנטוספירה תפקיד מרכזי בהגנה מקרינה ורוחות שמש. לוויין טבעי יחיד — הירח — משפיע על הגאות והשפל וייצב את ציר הסיבוב.
`,
        "מאדים": `
<b>מאדים</b><br>
אדמדם בשל תחמוצות ברזל. אטמוספירה דלילה (בעיקר CO₂). מאכלס את אולימפוס מונס — ההר הגבוה במערכת, ואת שבר העמקים העצום ואלס מרינריס. שני ירחים קטנים — פובוס ודימוס. עדויות מצביעות על מים זורמים בעבר, וכיום על קרח.
`,
        "צדק": `
<b>צדק</b><br>
הגדול בכוכבי הלכת, ענק גזי בעל פסים צבעוניים וסופות עזות, הבולטת שבהן היא ה"כתם האדום הגדול" — סערה שנמשכת מאות שנים. בעל מגנטוספרה חזקה במיוחד ועשרות ירחים, ביניהם ארבעת ירחי הגליליאו: איו, אירופה, גנימד וקליסטו.
`,
        "שבתאי": `
<b>שבתאי</b><br>
ענק גזי מרהיב המוקף מערכת טבעות ענק עשויות קרח ואבק. צפיפותו נמוכה עד כדי כך שאם היה "אוקיינוס" עצום — היה צף. ירחים מעניינים: <i>טיטאן</i> עם אטמוספירה עבה ואגמי מתאן, ו<i>אנקלדוס</i> שפולט סילוני קרח.
`,
        "אורנוס": `
<b>אורנוס</b><br>
תכול־קר בשל מתאן באטמוספירה. נטיית ציר קיצונית (~98°) גורמת לכך שהוא "שוכב על צידו" — עונות נמשכות כ־20 שנה כל אחת. יש לו מערכת טבעות דקה ומספר ירחים כהים.
`,
        "נפטון": `
<b>נפטון</b><br>
הרחוק ביותר מן השמש. רוחותיו מהמהירות במערכת (עד מעל 2,000 קמ"ש). משלים הקפה סביב השמש בכ־165 שנים. ירחו הגדול טריטון נע במסלול נגדי (רטרוגרדי) ועשוי להיות גרם שמיים שנלכד.
`
      };
      ...
      // התאמה אוטומטית לכל המסך (גם מובייל)
      const fitAll = ()=>{
        if (!wrap || !uni) return;
        // חישוב מדויק לפי רנדר בפועל
